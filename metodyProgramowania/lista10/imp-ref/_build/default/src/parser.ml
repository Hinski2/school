...
type ('s, 'r) _menhir_state = 
  ...
  | MenhirState51 : ((('s, _menhir_box_prog) _menhir_cell1_IF, _menhir_box_prog) _menhir_cell1_bexp, _menhir_box_prog) _menhir_state
    (** State 51.
        Stack shape : IF bexp.
        Start symbol: prog. *)

  | MenhirState53 : (('s, _menhir_box_prog) _menhir_cell1_IDENT, _menhir_box_prog) _menhir_state
    (** State 53.
        Stack shape : IDENT.
        Start symbol: prog. *)

  | MenhirState55 : (('s, _menhir_box_prog) _menhir_cell1_BEGIN, _menhir_box_prog) _menhir_state
    (** State 55.
        Stack shape : BEGIN.
        Start symbol: prog. *)

  | MenhirState56 : ((('s, _menhir_box_prog) _menhir_cell1_BEGIN, _menhir_box_prog) _menhir_cell1_list_var_decl_, _menhir_box_prog) _menhir_state
    (** State 56.
        Stack shape : BEGIN list(var_decl).
        Start symbol: prog. *)
...
include struct
  ...
  and _menhir_run_56 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_BEGIN as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      ...
      | IDENT _v_0 ->
          _menhir_run_52 _menhir_stack _menhir_lexbuf _menhir_lexer _v_0 MenhirState56
      | BEGIN ->
  ...
  and _menhir_run_54 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_IDENT as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | TIMES ->
  ...
  and _menhir_run_55 : type  ttv_stack. ttv_stack -> _ -> _ -> (ttv_stack, _menhir_box_prog) _menhir_state -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _menhir_s ->
  ...
  and _menhir_run_57 : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      ...
      | IDENT _v_0 ->
          _menhir_run_52 _menhir_stack _menhir_lexbuf _menhir_lexer _v_0 MenhirState57
      | BEGIN ->
          _menhir_run_55 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState57
      | END ->
          let _v_1 = _menhir_action_21 () in
  ...
  and _menhir_run_59 : type  ttv_stack. ((ttv_stack, _menhir_box_prog) _menhir_cell1_BEGIN, _menhir_box_prog) _menhir_cell1_list_var_decl_ -> _ -> _ -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v ->
      let _tok = _menhir_lexer _menhir_lexbuf in
      let MenhirCell1_list_var_decl_ (_menhir_stack, _, vs) = _menhir_stack in
  ...
  and _menhir_run_06 : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      ...
      | IDENT _v_0 ->
          _menhir_run_52 _menhir_stack _menhir_lexbuf _menhir_lexer _v_0 MenhirState06
      | BEGIN ->
          _menhir_run_55 _menhir_stack _menhir_lexbuf _menhir_lexer MenhirState06
      | _ ->
          _eRR ()
